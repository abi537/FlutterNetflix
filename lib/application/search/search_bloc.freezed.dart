...
mixin _$SearchState {
 ...
 List<SearchResultData> get searchresultList; List<Downloadsfd> get idleList; bool get isLoading; bool get isError;
...
@useResult
$Res call({
 List<SearchResultData> searchresultList, List<Downloadsfd> idleList, bool isLoading, bool isError
});
...
class _SearchState implements SearchState {
  const _SearchState({required final  List<SearchResultData> searchresultList, required final  List<Downloadsfd> idleList, required this.isLoading, required this.isError}): _searchresultList = searchresultList,_idleList = idleList;
...
@override List<SearchResultData> get searchresultList {
 ...
 final  List<Downloadsfd> _idleList;
@override List<Downloadsfd> get idleList {
